...
#et-AzContext -Subscription d1fa44a9-57ec-483b-895f-c83b675e0eb0
Connect-AzAccount -Credential $pscredential -Tenant $tenantId   -ServicePrincipal
...
<#
# Reading the key valut to get the Database Password 
try
        {
...
<# will not apply Database Changes 
...
# New Update DB Passowrd Logic
  ...
  $connectionDetails = ConvertFrom-Json '{
"createOrReplace": {
"object": {
"database": "Fin_COPA_lxdOPT",
"dataSource": "SQL/azr-sql-dai-entdl-300 database windows net;azr-adw-dai-entdl-300"
},
"dataSource": {
"type": "structured",
...
"protocol": "tds",
"address": {
"server": "azr-sql-dai-entdl-300.database.windows.net",
"database": "azr-adw-dai-entdl-300"
},
"authentication": null,
"query": null
},
...
$connectionDetails.createOrReplace.dataSource.credential.Username = "upnlogin"
$connectionDetails.createOrReplace.dataSource.credential.Password = "vNext is now reality 2019"
...
#$jsondata  = $tsml
write-Output " json " $tsml.createOrReplace.dataSource.credential.Username
# Process Password

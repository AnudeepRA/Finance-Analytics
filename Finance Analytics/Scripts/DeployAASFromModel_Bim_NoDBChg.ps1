...
<# will not read KV for databases this model will process the databases as is
try
        {
...
Catch {         
        ...
        Write-Output " Leonard " $StartIPAddress "  " $aasServer  "    "  $jsondata
  ...
  Write-Output "  " $StartIPAddress "  " $aasServer 
